...
// Tipos adaptados para interoperabilidade com Store e Admin de forma independente
...
class WhatsappService {
    ...
    async sendOrderStatusMessage(order: WhatsappOrder, status: OrderStatus): Promise<void> {
        const settings = await this.getSettings();
